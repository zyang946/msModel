 ...
 * </p>
 * <ul>
 *   <li>{@link rEMODEL.impl.SwitchExpImpl#getName <em>Name</em>}</li>
 *   <li>{@link rEMODEL.impl.SwitchExpImpl#getCases <em>Cases</em>}</li>
 *   <li>{@link rEMODEL.impl.SwitchExpImpl#getDefault <em>Default</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchExpImpl extends JoinExpImpl implements SwitchExp {
	...
	protected EClass eStaticClass() {
		return REMODELPackage.Literals.SWITCH_EXP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, REMODELPackage.SWITCH_EXP__NAME, oldName, name));
	}
	...
	public EList<SwitchCase> getCases() {
		if (cases == null) {
			cases = new EObjectContainmentEList<SwitchCase>(SwitchCase.class, this, REMODELPackage.SWITCH_EXP__CASES);
		}
		return cases;
	}
	...
	public NotificationChain basicSetDefault(SwitchDefault newDefault, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					REMODELPackage.SWITCH_EXP__DEFAULT, oldDefault, newDefault);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDefault != default_) {
			...
			if (default_ != null)
				msgs = ((InternalEObject) default_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - REMODELPackage.SWITCH_EXP__DEFAULT, null, msgs);
			if (newDefault != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, REMODELPackage.SWITCH_EXP__DEFAULT, newDefault,
					newDefault));
	}
