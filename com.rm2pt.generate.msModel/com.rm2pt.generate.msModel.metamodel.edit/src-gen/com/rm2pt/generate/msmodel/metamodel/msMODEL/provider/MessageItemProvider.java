...
/**
 * This is the item provider adapter for a {@link com.rm2pt.generate.msmodel.metamodel.msMODEL.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MsMODELPackage.Literals.MESSAGE__NAME, true, false, false,
	...
	protected void addGuardPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Message_guard_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Message_guard_feature",
								"_UI_Message_type"),
						MsMODELPackage.Literals.MESSAGE__GUARD, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MsMODELPackage.Literals.MESSAGE__TO, true, false, true, null, null, null));
	}
	...
	protected void addActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Message_action_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Message_action_feature",
								"_UI_Message_type"),
						MsMODELPackage.Literals.MESSAGE__ACTION, true, false, true, null, null, null));
	}
