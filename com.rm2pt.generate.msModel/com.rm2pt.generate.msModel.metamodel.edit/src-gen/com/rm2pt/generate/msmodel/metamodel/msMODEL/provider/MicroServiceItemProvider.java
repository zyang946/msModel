...
/**
 * This is the item provider adapter for a {@link com.rm2pt.generate.msmodel.metamodel.msMODEL.MicroService} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MicroServiceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addProvidePropertyDescriptor(object);
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MsMODELPackage.Literals.MICRO_SERVICE__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Provide feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addProvidePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MicroService_provide_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_MicroService_provide_feature",
								"_UI_MicroService_type"),
						MsMODELPackage.Literals.MICRO_SERVICE__PROVIDE, true, false, true, null, null, null));
	}
	...
	protected void addUsePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MicroService_use_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_MicroService_use_feature",
								"_UI_MicroService_type"),
						MsMODELPackage.Literals.MICRO_SERVICE__USE, true, false, true, null, null, null));
	}
	...
	protected void addRequirePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MicroService_require_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_MicroService_require_feature",
								"_UI_MicroService_type"),
						MsMODELPackage.Literals.MICRO_SERVICE__REQUIRE, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MsMODELPackage.Literals.MICRO_SERVICE__DOMAINMODEL);
			childrenFeatures.add(MsMODELPackage.Literals.MICRO_SERVICE__OPERATION);
			childrenFeatures.add(MsMODELPackage.Literals.MICRO_SERVICE__CONTRACT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MsMODELPackage.Literals.MICRO_SERVICE__DOMAINMODEL,
				REMODELFactory.eINSTANCE.createDomainModel()));

		newChildDescriptors.add(createChildParameter(MsMODELPackage.Literals.MICRO_SERVICE__OPERATION,
				REMODELFactory.eINSTANCE.createOperation()));

		newChildDescriptors.add(createChildParameter(MsMODELPackage.Literals.MICRO_SERVICE__CONTRACT,
