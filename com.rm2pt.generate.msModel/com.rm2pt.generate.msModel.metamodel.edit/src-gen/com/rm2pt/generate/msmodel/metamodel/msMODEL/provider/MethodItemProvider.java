...
import com.rm2pt.generate.msmodel.metamodel.msMODEL.Method;
...
/**
 * This is the item provider adapter for a {@link com.rm2pt.generate.msmodel.metamodel.msMODEL.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MsMODELPackage.Literals.METHOD__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Method_returnType_feature",
								"_UI_Method_type"),
						MsMODELPackage.Literals.METHOD__RETURN_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MsMODELPackage.Literals.METHOD__PARAMENT);
			childrenFeatures.add(MsMODELPackage.Literals.METHOD__CONTRACT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case MsMODELPackage.METHOD__NAME:
		case MsMODELPackage.METHOD__RETURN_TYPE:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case MsMODELPackage.METHOD__PARAMENT:
		case MsMODELPackage.METHOD__CONTRACT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MsMODELPackage.Literals.METHOD__PARAMENT,
				MsMODELFactory.eINSTANCE.createParament()));

		newChildDescriptors.add(createChildParameter(MsMODELPackage.Literals.METHOD__CONTRACT,
