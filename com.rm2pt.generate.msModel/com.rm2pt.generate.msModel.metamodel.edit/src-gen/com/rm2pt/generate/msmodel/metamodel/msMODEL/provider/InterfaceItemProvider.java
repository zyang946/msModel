...
/**
 * This is the item provider adapter for a {@link com.rm2pt.generate.msmodel.metamodel.msMODEL.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Interface_name_feature",
								"_UI_Interface_type"),
						MsMODELPackage.Literals.INTERFACE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MsMODELPackage.Literals.INTERFACE__CALLCHAIN);
			childrenFeatures.add(MsMODELPackage.Literals.INTERFACE__CONTRACT);
			childrenFeatures.add(MsMODELPackage.Literals.INTERFACE__OPERATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MsMODELPackage.Literals.INTERFACE__CALLCHAIN,
				MsMODELFactory.eINSTANCE.createCallChain()));

		newChildDescriptors.add(createChildParameter(MsMODELPackage.Literals.INTERFACE__CONTRACT,
				REMODELFactory.eINSTANCE.createContract()));

		newChildDescriptors.add(createChildParameter(MsMODELPackage.Literals.INTERFACE__OPERATION,
