...
/**
 * This is the item provider adapter for a {@link com.rm2pt.generate.msmodel.metamodel.msMODEL.LifeLine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LifeLineItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_LifeLine_name_feature",
								"_UI_LifeLine_type"),
						MsMODELPackage.Literals.LIFE_LINE__NAME, true, false, false,
	...
	protected void addMicroservicePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_LifeLine_microservice_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_LifeLine_microservice_feature",
								"_UI_LifeLine_type"),
						MsMODELPackage.Literals.LIFE_LINE__MICROSERVICE, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MsMODELPackage.Literals.LIFE_LINE__MESSAGE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MsMODELPackage.Literals.LIFE_LINE__MESSAGE,
