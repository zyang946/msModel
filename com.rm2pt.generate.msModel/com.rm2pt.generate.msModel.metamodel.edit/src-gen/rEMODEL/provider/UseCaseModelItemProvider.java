...
/**
 * This is the item provider adapter for a {@link rEMODEL.UseCaseModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseCaseModelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						REMODELPackage.Literals.USE_CASE_MODEL__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_UseCaseModel_label_feature",
								"_UI_UseCaseModel_type"),
						REMODELPackage.Literals.USE_CASE_MODEL__LABEL, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(REMODELPackage.Literals.USE_CASE_MODEL__UC);
			childrenFeatures.add(REMODELPackage.Literals.USE_CASE_MODEL__ACTOR);
			childrenFeatures.add(REMODELPackage.Literals.USE_CASE_MODEL__INTERACTION);
			childrenFeatures.add(REMODELPackage.Literals.USE_CASE_MODEL__SERVICE);
			childrenFeatures.add(REMODELPackage.Literals.USE_CASE_MODEL__CONTRACT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(REMODELPackage.Literals.USE_CASE_MODEL__UC, REMODELFactory.eINSTANCE.createUC()));

		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.USE_CASE_MODEL__ACTOR,
				REMODELFactory.eINSTANCE.createActor()));

		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.USE_CASE_MODEL__INTERACTION,
				REMODELFactory.eINSTANCE.createInteraction()));

		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.USE_CASE_MODEL__SERVICE,
				REMODELFactory.eINSTANCE.createService()));

		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.USE_CASE_MODEL__CONTRACT,
