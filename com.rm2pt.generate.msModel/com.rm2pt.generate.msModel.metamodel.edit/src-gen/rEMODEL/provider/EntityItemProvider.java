...
/**
 * This is the item provider adapter for a {@link rEMODEL.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIsCRUDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						REMODELPackage.Literals.ENTITY__IS_CRUD, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						REMODELPackage.Literals.ENTITY__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Entity_superEntity_feature",
								"_UI_Entity_type"),
						REMODELPackage.Literals.ENTITY__SUPER_ENTITY, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Entity_description_feature",
								"_UI_Entity_type"),
						REMODELPackage.Literals.ENTITY__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(REMODELPackage.Literals.ENTITY__ATTRIBUTES);
			childrenFeatures.add(REMODELPackage.Literals.ENTITY__REFERENCE);
			childrenFeatures.add(REMODELPackage.Literals.ENTITY__INVARIANCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.ENTITY__ATTRIBUTES,
				REMODELFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.ENTITY__REFERENCE,
				REMODELFactory.eINSTANCE.createReference()));

		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.ENTITY__INVARIANCE,
