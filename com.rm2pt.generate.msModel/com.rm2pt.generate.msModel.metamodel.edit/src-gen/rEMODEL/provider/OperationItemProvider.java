...
/**
 * This is the item provider adapter for a {@link rEMODEL.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider extends JoinExpItemProvider {
	/**
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Operation_name_feature",
								"_UI_Operation_type"),
						REMODELPackage.Literals.OPERATION__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(REMODELPackage.Literals.OPERATION__PARAMETER);
			childrenFeatures.add(REMODELPackage.Literals.OPERATION__RETURN_TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.OPERATION__PARAMETER,
				REMODELFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.OPERATION__RETURN_TYPE,
