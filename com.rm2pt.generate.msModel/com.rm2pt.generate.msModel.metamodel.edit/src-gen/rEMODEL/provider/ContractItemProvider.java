...
/**
 * This is the item provider adapter for a {@link rEMODEL.Contract} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContractItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addOpPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Contract_op_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Contract_op_feature", "_UI_Contract_type"),
						REMODELPackage.Literals.CONTRACT__OP, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(REMODELPackage.Literals.CONTRACT__DEF);
			childrenFeatures.add(REMODELPackage.Literals.CONTRACT__PRE);
			childrenFeatures.add(REMODELPackage.Literals.CONTRACT__POST);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.CONTRACT__DEF,
				REMODELFactory.eINSTANCE.createDefinition()));

		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.CONTRACT__PRE,
				REMODELFactory.eINSTANCE.createPrecondition()));

		newChildDescriptors.add(createChildParameter(REMODELPackage.Literals.CONTRACT__POST,
