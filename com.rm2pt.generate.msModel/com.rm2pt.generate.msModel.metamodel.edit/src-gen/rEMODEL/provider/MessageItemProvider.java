...
import rEMODEL.Message;
import rEMODEL.REMODELPackage;

/**
 * This is the item provider adapter for a {@link rEMODEL.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						REMODELPackage.Literals.MESSAGE__NAME, true, false, false,
	...
	protected void addSendingEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Message_sendingEnd_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Message_sendingEnd_feature",
								"_UI_Message_type"),
						REMODELPackage.Literals.MESSAGE__SENDING_END, true, false, true, null, null, null));
	}
	...
	protected void addReceivingEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Message_receivingEnd_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Message_receivingEnd_feature",
								"_UI_Message_type"),
						REMODELPackage.Literals.MESSAGE__RECEIVING_END, true, false, true, null, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case REMODELPackage.MESSAGE__NAME:
