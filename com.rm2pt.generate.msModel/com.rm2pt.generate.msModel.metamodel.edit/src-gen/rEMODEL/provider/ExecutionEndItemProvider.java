...
/**
 * This is the item provider adapter for a {@link rEMODEL.ExecutionEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExecutionEndItemProvider extends MixEndItemProvider {
	/**
	...
	protected void addExecutionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ExecutionEnd_execution_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ExecutionEnd_execution_feature",
								"_UI_ExecutionEnd_type"),
						REMODELPackage.Literals.EXECUTION_END__EXECUTION, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ExecutionEnd_type")
